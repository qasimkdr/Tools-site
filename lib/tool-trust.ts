...
const categoryTrust: Record<string, ToolTrust> = {
  ...
  Vehicles:{method:"Uses distance, efficiency, price and ownership assumptions entered by the user. Actual performance depends on route, vehicle condition and changing prices.",sources:[{name:"Pakistan State Oil fuel prices",url:"https://psopk.com/en/fuel-prices"}]},
