...
export function Header(){return <header className="site-header"><div className="shell nav-wrap"><Logo/><nav aria-label="Primary navigation"><Link href="/image-tools/">Image tools</Link><Link href="/document-tools/">Document tools</Link><Link href="/pdf-tools/">PDF tools</Link><Link href="/tools/">Global tools</Link><Link href="/pk/tools/">Pakistan tools</Link><Link href="/guides/">Guides</Link><Link href="/about/">About</Link></nav><NavbarSearch entries={searchEntries}/><Link className="nav-cta" href="/image-tools/">Image tools <span>→</span></Link></div></header>}
