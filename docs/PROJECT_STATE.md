...
- New pages: minimum 900 useful rendered words.
- Build must validate metadata, structured data, content depth, internal links and discovery.
- New calculations must work locally and expose assumptions.
- Render auto-deployment must be checked after publishing.

Run `npm run context:report` for live build-output counts rather than manually recounting pages.
